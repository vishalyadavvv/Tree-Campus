        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" 
                 ...
                 style={{ backgroundColor: 'rgba(253, 90, 0, 0.1)', borderRadius: '8px' }}
                 onMouseEnter={(e) => e.currentTarget.style.backgroundColor = `rgba(253, 90, 0, 0.2)`}
                 onMouseLeave={(e) => e.currentTarget.style.backgroundColor = `rgba(253, 90, 0, 0.1)`}>
              ...
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" 
                 className="text-gray-400 hover:text-white transition-colors duration-300 p-2 rounded-lg"
                 style={{ backgroundColor: 'rgba(253, 90, 0, 0.1)' }}
                 onMouseEnter={(e) => e.currentTarget.style.backgroundColor = `rgba(253, 90, 0, 0.2)`}
                 onMouseLeave={(e) => e.currentTarget.style.backgroundColor = `rgba(253, 90, 0, 0.1)`}>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/contact" className="text-gray-400 hover:text-white transition-colors duration-300 text-sm flex items-center">
                  <span style={{ width: '6px', height: '6px', backgroundColor: primaryColor, borderRadius: '50%', marginRight: '10px' }}></span>
                  Contact Us
                </Link>
              </li>
              ...
              <li>
                <Link to="/blog" className="text-gray-400 hover:text-white transition-colors duration-300 text-sm flex items-center">
                  <span style={{ width: '6px', height: '6px', backgroundColor: primaryColor, borderRadius: '50%', marginRight: '10px' }}></span>
                  Blog
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/schoolregistration" className="text-gray-400 hover:text-white transition-colors duration-300 text-sm flex items-center">
                  <span style={{ width: '6px', height: '6px', backgroundColor: primaryColor, borderRadius: '50%', marginRight: '10px' }}></span>
                  Register School
                </Link>
              </li>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <a
                ...
                style={{ backgroundColor: 'rgba(253, 90, 0, 0.1)', borderColor: primaryColor }}
              >
